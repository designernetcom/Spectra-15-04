...
$(document).ready(function () {
    ...
    let fileToDownload = ''; // Variable to hold the file URL

    // Open popup on button click
    $('.open-popup').on('click', function () {
        fileToDownload = $(this).data('file'); // Get the file URL from the button's data attribute
        popupOverlay.fadeIn();
        popupForm.fadeIn();
    });
    ...
    $('#popupForm').on('submit', function (e) {
        ...
        if (fileToDownload) {
            window.location.href = fileToDownload; // Redirect to the file URL
        }
    });
});
